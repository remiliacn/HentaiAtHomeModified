...
public class Settings {
    ...
    private static final Object rpcServerLock = new Object();
    ...
    public static void loadClientLoginFromFile() {
    ...
    public static void parseAndUpdateSettings(String[] settings) {
        if (settings == null) {
            return;
        }
    ...
    public static void updateSetting(String setting, String value) {
        ...
        try {
            if (setting.equals("min_client_build")) {
                ...
                staticRanges = new Hashtable<>((int) (value.length() * 0.3));
    ...
    public static int getMaxConnections() {
        if (overrideConns > 0) {
            ...
            return MAX_CONNECTION_BASE + Math.min(480, throttle_bytes / 10000);
        }
    }
