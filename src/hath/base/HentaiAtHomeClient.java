...
public class HentaiAtHomeClient implements Runnable {
    public static final String[] EXIT_STRINGS = new String[]{"I don't hate you", "Whyyyyyyyy...", "No hard feelings", "Your business is appreciated", "Good-night"};
    ...
    private void shutdown(boolean fromShutdownHook, String shutdownErrorMessage) {
        ...
        if (!shutdown) {
            ...
            if (Math.random() > 0.99) {
                ...
                Out.info(EXIT_STRINGS[(int) Math.floor(Math.random() * EXIT_STRINGS.length)]);
            }
