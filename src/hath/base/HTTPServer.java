...
public class HTTPServer implements Runnable {
    ...
    public HTTPServer(HentaiAtHomeClient client) {
        this.client = client;
        sessions = Collections.checkedList(new ArrayList<>(), HTTPSession.class);
        floodControlTable = new Hashtable<>();
    ...
    public void pruneFloodControlTable() {
        List<String> toPrune = Collections.checkedList(new ArrayList<>(), String.class);
    ...
    public void nukeOldConnections() {
        ...
        List<HTTPSession> remove = Collections.checkedList(new ArrayList<>(), HTTPSession.class);
    ...
    private static class FloodControlEntry {
        ...
        public boolean hit() {
            ...
            connectCount = Math.max(0, connectCount - (int) Math.floor((double) (nowtime - lastConnect) / 1000)) + 1;
            lastConnect = nowtime;
